...
if (isset($_SESSION['email']) && isset($_POST['savebutton']))   {
	...
	$updatedb="UPDATE fm_users SET first_name=\"" .  $first_name . "\", last_name=\"" . $last_name .  "\", title=\"" . $title ."\" WHERE email = \"" . $email . "\""; //"UPDATE fm_users SET first_name=\"" .  $first_name .  "\" WHERE email = \"" . $email . "\"";
