...
<html lang="en" dir="ltr">
  ...
  <body>
    <div align="center">
      <?php
      echo (basename($_SERVER['PHP_SELF']) == "password.php") ? "<strong><a href=password.php style=\"text-decoration: none\" style=\"font-size:50px;\">|Home</a></strong>" : "<a href=password.php style=\"text-decoration: none\">|Home</a>";
      echo "|&nbsp&nbsp";
